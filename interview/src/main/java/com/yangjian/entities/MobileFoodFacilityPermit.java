...
@Schema(title = "MobileFood table")
public class MobileFoodFacilityPermit {
    @Id
    @GeneratedValue(generator = "JDBC")
    @Schema(title = "locationid")
    ...
    @Schema(title = "received")
    @Column(name = "Received")
    private Integer received;

    @Schema(title = "priorpermit")
    @Column(name = "PriorPermit")
    private Integer priorpermit;

    @Schema(title = "firePreventionDistricts")
